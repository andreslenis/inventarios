...
include ("../seguridad.php");
	if (empty($_POST['mod_id'])) {
		...
		$sql="UPDATE products SET codigo_producto='".$codigo."', nombre_producto='".$nombre."', id_categoria='".$categoria."', talla='".$talla."', precio_producto='".$precio_venta."', stock='".$stock."' WHERE id_producto='".$id_producto."'";
