...
include ("../seguridad.php");
	if (empty($_POST['mod_id'])) {
		...
		$sql="UPDATE pedidos SET codigo_producto='".$codigo."', nombre_producto='".$nombre."', id_categoria='".$categoria."', precio_producto='".$precio_venta."', stock='".$stock."' WHERE id_producto='".$id_producto."'";
