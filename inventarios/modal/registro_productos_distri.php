	  ...
	  <div class="modal-dialog" role="document">
		<div class="modal-content">
		  ...
		  <div class="modal-body">
			<form class="form-horizontal" method="post" id="guardar_producto_pedidos" name="guardar_producto_pedidos">
		  ...
		  <div class="modal-footer">
			...
			<button type="submit" class="btn btn-primary" id="guardar_datos_pedidos">Guardar datos</button>
		  </div>
		  </form>
		</div>
	  </div>
