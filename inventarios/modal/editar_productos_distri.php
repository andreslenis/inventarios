	  ...
	  <div class="modal-dialog" role="document">
		<div class="modal-content">
		  ...
		  <div class="modal-body">
			<form class="form-horizontal" method="post" id="editar_producto_pedido" name="editar_producto_pedido">
			<div id="resultados_ajax2"></div>
			  ...
			  <div class="form-group">
				...
				<div class="col-sm-8">
				  <input type="text" class="form-control" id="mod_talla" name="mod_talla" placeholder="Talla del producto" required pattern="^[0-9]{1,5}(\.[0-9]{0,2})?$" title="Ingresa sólo números o letra unica" maxlength="8">
				</div>
			  </div>
			  <div class="form-group">
