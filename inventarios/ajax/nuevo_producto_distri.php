...
include ("../seguridad.php");
	...
	if (empty($_POST['codigo'])) {
		...
		$sql="INSERT INTO pedidos (codigo_producto, nombre_producto, date_added, precio_producto, stock, id_categoria) VALUES ('$codigo','$nombre','$date_added','$precio_venta', '$stock','$id_categoria')";
		$query_new_insert = mysqli_query($con,$sql);
			if ($query_new_insert){
				$messages[] = "Producto ha sido ingresado satisfactoriamente.";
				/*$id_producto=get_row('pedidos','id_producto', 'codigo_producto', $codigo);
