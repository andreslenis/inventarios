		...
		function load(page){
			...
			$("#loader").fadeIn('slow');
			$.ajax({
				url:'./ajax/buscar_categorias_gerente.php?action=ajax&page='+page+'&q='+q,
	...
	function eliminar (id)
		...
		$.ajax({
        type: "GET",
        url: "./ajax/buscar_categorias_gerente.php",
        data: "id="+id,"q":q,
		 beforeSend: function(objeto){
...
$( "#guardar_categoria" ).submit(function( event ) {
 ...
 var parametros = $(this).serialize();
	 $.ajax({
			type: "POST",
			url: "ajax/nueva_categoria_gerente.php",
			data: parametros,
			 beforeSend: function(objeto){
...
$( "#editar_categoria" ).submit(function( event ) {
 ...
 var parametros = $(this).serialize();
	 $.ajax({
			type: "POST",
			url: "ajax/editar_categoria_gerente.php",
			data: parametros,
			 beforeSend: function(objeto){
